...
export class BitbucketLoginModal extends React.Component<Props, State> {
    static defaultProps = {
        loginLabel: 'Login'
    };
    ...
    login = (e: React.SyntheticEvent) => {
        ...
        this.setState({
            ...
            api.authenticateBitbucket(login, password)
                .then(authenticated => {
                    console.log('authenticated bitbucket?', authenticated);
                    if (authenticated) {
                        this.setState({
                            show: false,
                            authenticating: false,
    ...
    render() {
        ...
        return (
            <B.ModalCard show={show} onHide={onHide} title='Bitbucket(Stash) Login' keyboard footer={footer}>
                <B.Content>
                    <form>
                        <B.Control>
