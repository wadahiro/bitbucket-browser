...
export class JiraLoginModal extends React.Component<Props, State> {
    static defaultProps = {
        loginLabel: 'Login'
    };
    ...
    login = (e: React.SyntheticEvent) => {
        ...
        this.setState({
            ...
            api.authenticateJira(login, password)
                .then(authenticated => {
                    console.log('authenticated jira?', authenticated);
                    if (authenticated) {
                        this.setState({
                            show: false,
                            authenticating: false,
    ...
    render() {
        ...
        return (
            <B.ModalCard show={show} onHide={onHide} title='JIRA Login' keyboard footer={footer}>
                <B.Content>
                    <form>
                        <B.Control>
